    ...
    <View style={styles.root}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        <View style={styles.heroWrap}>
          ...
          {item.popular ? <View style={styles.heroBadge}><BestsellerBadge /></View> : null}
        </View>

        <View style={styles.body}>
          <View style={styles.vegRow}><VegBadge veg={item.veg} size={18} /><Text style={styles.cat}>{item.category}</Text></View>
